...
const OILSLICK_SEQUENCE = [
  {
    ...
    message: (n) => [
      ...
      '• We have been carrying Oil Slick since 2012 out of Washington state',
      '• Medical grade non-stick silicone and FEP materials',
      '• Wholesale pricing on extraction and packaging supplies',
      '• Custom printing available on pads, paper, jars, boxes',
      '',
  ...
  },
  {
    ...
    message: (n) => [
      ...
      '• Wholesale pricing on the full Oil Slick lineup.',
      '• Custom branding available. Your logo on pads, paper, jars, boxes.',
  ...
  },
  {
    ...
    subject: (n) => `15% off your Oil Slick order${n ? `, ${n}` : ''}`,
    message: (n) => [
      `Hi${n ? ` ${n}` : ''},`,
      '',
      'Last email about your cart. We put 15% off on your order below, which is the best we can do on extraction and packaging supplies.',
      '',
      'A few things people ask us:',
      '• "Do you do volume pricing?" Yes. Reply and we will put a quote together.',
      '• "Can you print my logo?" Yes, on pads, paper, jars, boxes.',
      '• "How long have you been around?" We have been carrying Oil Slick products since 2012 out of Washington state.',
      '',
      'This discount expires in 24 hours.',
      '',
      'If you need a different quantity or something we do not have listed, just reply and we will figure it out.',
      '',
      'Oil Slick Pad',
    ].join('\n'),
  },
...
const MIXED_SEQUENCE = [
  ...
  },
  {
    ...
    message: (n) => [
      ...
      '• Oil Slick extraction supplies at wholesale',
