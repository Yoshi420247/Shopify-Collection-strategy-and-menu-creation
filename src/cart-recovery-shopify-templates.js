...
const SMOKESHOP_SEQUENCE = [
  // EMAIL 1 — Impulse recovery (1hr)
  // Chase Dimond: "First email = pure reminder. No discount. 50%+ open rate."
  {
    id: 'smoke_reminder',
    step: 1,
    delayHours: 1,
    discountPercent: 0,
    discountCode: null,
    subject: (n) => `Your ${n ? n + "'s " : ''}cart is getting cold`,
    message: (n) => [
      `Hey${n ? ` ${n}` : ''},`,
      '',
      'You left some fire in your cart. We saved it for you — but we can\'t hold it forever.',
      '',
      'Click below to pick up where you left off. Same items, same price, ready to go.',
      '',
      'Questions about your order? Just hit reply — we answer every email personally.',
      '',
      '— The Oil Slick Pad Team',
      'Wholesale prices. Discreet shipping. Since 2012.',
    ].join('\n'),
  },
  // EMAIL 2 — Social proof + light discount (24hr)
  // Ezra Firestone: "Lead with value and social proof before discounting."
  {
    ...
    subject: (n) => `${n || 'Hey'}, people are loving this piece`,
    message: (n) => [
      `Hey${n ? ` ${n}` : ''},`,
      '',
      'Still thinking about it? Here\'s what you should know:',
      '',
      'Customers who buy from Oil Slick Pad come back an average of 3+ times. That\'s not an accident — it\'s because we only carry quality pieces at wholesale prices.',
      '',
      'Here\'s what sets us apart:',
      '• Wholesale pricing — we cut out the headshop markup',
      '• Thick glass, premium materials — no cheap knockoffs',
      '• Discreet shipping — plain box, bubble wrapped, fast',
      '• 10,000+ orders shipped since 2012',
      '',
      'To make it easy, we\'ve applied 10% off to your order below.',
      '',
      '— The Oil Slick Pad Team',
    ].join('\n'),
  },
  // EMAIL 3 — Urgency + stronger discount (48hr)
  // Chase Dimond: "Email 3 is where urgency converts. Pair scarcity with discount."
  {
    id: 'smoke_urgency',
    step: 3,
    delayHours: 48,
    ...
    message: (n) => [
      `${n || 'Hey'},`,
      '',
      'Your cart has been sitting for 2 days, and we want to make this easy for you.',
      '',
      'We\'ve applied 20% off — that\'s real savings on wholesale prices that are already lower than your local shop.',
      '',
      'This offer expires in 24 hours. After that, we can\'t guarantee your items will still be in stock.',
      '',
      'Click below to grab your gear before someone else does.',
      '',
      '— The Oil Slick Pad Team',
      '',
      'P.S. Free shipping on orders over $75. You might be closer than you think.',
    ].join('\n'),
  },
  // EMAIL 4 — FOMO + max discount (72hr)
  // Drew Sanocki: "Final push = max discount + clear deadline. Then stop."
  {
    id: 'smoke_final',
    step: 4,
    delayHours: 72,
    ...
    subject: (n) => `Last call: 30% off expires at midnight`,
    message: (n) => [
      `${n || 'Hey'},`,
      '',
      'This is our last email about your cart — and our best offer.',
      '',
      '30% off everything in your cart. That\'s our absolute maximum discount, and it\'s only available for the next 24 hours.',
      '',
      'After that, this offer disappears and won\'t come back.',
      '',
      'We don\'t do this often. At these prices, we\'re barely covering cost — but we\'d rather earn a customer than lose one.',
      '',
      'Click below to complete your order at 30% off.',
      '',
      '— Joshua & The Oil Slick Pad Team',
      '',
      'P.S. If something else stopped you — payment issues, shipping questions, anything — reply to this email. We\'ll fix it.',
    ].join('\n'),
  },
];

const OILSLICK_SEQUENCE = [
  // EMAIL 1 — Professional reminder (1hr)
  // Austin Brawner: "High-AOV buyers need consultative tone, not pushy sales."
  {
    id: 'oil_reminder',
    step: 1,
    delayHours: 1,
    discountPercent: 0,
    discountCode: null,
    subject: (n) => `Your Oil Slick order is saved, ${n || 'there'}`,
    message: (n) => [
      `Hi${n ? ` ${n}` : ''},`,
      '',
      'We noticed you started an order for Oil Slick extraction and packaging supplies. Everything is saved and ready when you are.',
      '',
      'If you\'re comparing options or need to check with your team — no problem. We\'re here when you\'re ready.',
      '',
      'Quick reminder of what makes Oil Slick different:',
      '• Made in the USA — Colorado-based since 2012',
      '• Medical-grade, non-stick silicone and FEP materials',
      '• Direct from the manufacturer — no distributor markup',
      '• Custom printing available on pads, paper, and packaging',
      '',
      'Click below to complete your order, or reply to this email if you have any questions.',
      '',
      '— The Oil Slick Pad Team',
    ].join('\n'),
  },
  // EMAIL 2 — Consultative value + light discount (24hr)
  // Ezra Firestone: "For B2B, lead with ROI and operational value, not emotion."
  {
    id: 'oil_value',
    step: 2,
    delayHours: 24,
    ...
    subject: (n) => `A note about your Oil Slick order`,
    message: (n) => [
      `Hi${n ? ` ${n}` : ''},`,
      '',
      'Following up on the Oil Slick supplies in your cart.',
      '',
      'We know extraction and packaging supplies are a business decision, not an impulse buy. So here\'s what our wholesale customers tell us they value most:',
      '',
      '• Consistency — same quality every batch, every order',
      '• Direct pricing — you\'re buying from the manufacturer',
      '• Custom branding — we print your logo on pads, paper, jars, and boxes',
      '• Compliance-ready — child-resistant packaging options available',
      '',
      'We\'ve applied 5% off to your order below as a thank-you for considering us.',
      '',
      'Need a custom quote for larger quantities? Reply to this email and we\'ll put together volume pricing for you.',
      '',
      '— The Oil Slick Pad Team',
      'Made in Colorado | Since 2012',
    ].join('\n'),
  },
  // EMAIL 3 — Volume pitch + stronger discount (48hr)
  {
    id: 'oil_volume',
    step: 3,
    delayHours: 48,
    ...
    subject: (n) => `10% off your Oil Slick supplies — limited time`,
    message: (n) => [
      `${n || 'Hi'},`,
      '',
      'Still considering your Oil Slick order? Here\'s our best offer.',
      '',
      'We\'ve applied 10% off your entire order. For extraction and packaging supplies, that adds up fast — especially on repeat orders.',
      '',
      'A few things worth mentioning:',
      '• Bulk pricing available — reply for a custom quote on case quantities',
      '• Repeat customers get priority on custom print runs',
      '• We ship nationwide with plain, professional packaging',
      '',
      'This offer expires in 48 hours.',
      '',
      'Click below to complete your order at 10% off.',
      '',
      '— The Oil Slick Pad Team',
    ].join('\n'),
  },
  // EMAIL 4 — Final outreach + max discount (5 days)
  // Austin Brawner: "For B2B, final email = personal touch + open door for conversation"
  {
    id: 'oil_final',
    step: 4,
    delayHours: 120,
    ...
    subject: (n) => `Quick question about your order, ${n || 'there'}`,
    message: (n) => [
      `Hi${n ? ` ${n}` : ''},`,
      '',
      'Joshua here, owner of Oil Slick Pad.',
      '',
      'I noticed you were looking at some of our extraction and packaging supplies but didn\'t finish your order. I wanted to personally reach out and see if there\'s anything I can help with.',
      '',
      'Common questions we get:',
      '• "Do you offer volume pricing?" — Yes, reply for a custom quote',
      '• "Can I get my logo printed?" — Absolutely, custom prints on all products',
      '• "Is this the same quality as [competitor]?" — We\'re the original. Made in USA since 2012.',
      '',
      'I\'ve applied our maximum discount — 15% off your order below. This is as low as we can go on extraction supplies while keeping quality where it needs to be.',
      '',
      'If you need something we don\'t have listed, or need a different quantity — just reply. I read every email.',
      '',
      '— Joshua Hill',
      'Owner, Oil Slick Pad',
...
const MIXED_SEQUENCE = [
  {
    ...
    discountPercent: 0,
    discountCode: null,
    subject: (n) => `You left something behind${n ? `, ${n}` : ''}`,
    message: (n) => [
      `Hey${n ? ` ${n}` : ''},`,
      '',
      'We saved your cart — smoking accessories and extraction supplies, all in one place.',
      '',
      'That\'s the beauty of Oil Slick Pad: one stop for everything from glass pieces to professional extraction packaging, all at wholesale prices.',
      '',
  ...
  },
  {
    ...
    discountPercent: 5,
    discountCode: 'EXTRACT5',
    subject: (n) => `5% off your cart — just for you`,
    message: (n) => [
      `Hey${n ? ` ${n}` : ''},`,
      '',
      'We noticed you had a mix of smoking accessories and extraction supplies in your cart. Not many stores carry both — that\'s what makes Oil Slick Pad different.',
      '',
      '• Smokeshop gear at wholesale — skip the headshop markup',
      '• Oil Slick extraction supplies — direct from the manufacturer',
      '• One order, one shipment, plain discreet packaging',
      '',
      'We\'ve applied 5% off your order below.',
      '',
      '— The Oil Slick Pad Team',
      'Since 2012 | 10,000+ orders shipped',
    ].join('\n'),
  },
  {
    id: 'mixed_urgency',
    ...
    discountPercent: 10,
    discountCode: 'EXTRACT10',
    subject: (n) => `10% off your cart expires soon`,
    message: (n) => [
      `${n || 'Hey'},`,
      '',
      'Your cart has been waiting for 2 days. We\'ve bumped your discount to 10% off — our best standard offer.',
      '',
      'This expires in 24 hours, then your saved items go back to general inventory.',
      '',
  ...
  },
  {
    ...
    discountPercent: 15,
    discountCode: 'EXTRACT15',
    subject: (n) => `Final offer: 15% off your cart`,
    message: (n) => [
      `${n || 'Hey'},`,
      '',
      'Last chance — we\'ve applied 15% off your entire cart. This is our maximum discount and it expires in 24 hours.',
      '',
      'If something stopped you — shipping, payment, questions about a product — reply to this email. We answer every one personally.',
      '',
      '— Joshua & The Oil Slick Pad Team',
    ].join('\n'),
  },
